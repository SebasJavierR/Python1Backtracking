...
def generar_laberinto(filas, columnas):
    ...
    for coordenada in grilla:
        grilla.posiciones[coordenada]=grilla.BLOQUEADA
        if coordenada==grilla.origen():
            grilla.posiciones[coordenada]=grilla.VISITADA
        elif coordenada==grilla.destino():
            grilla.posiciones[coordenada]=grilla.NO_VISITADA
